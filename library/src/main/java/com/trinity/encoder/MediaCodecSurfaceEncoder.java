...
public class MediaCodecSurfaceEncoder {
    ...
    public MediaCodecSurfaceEncoder(int width, int height, int bitRate, int frameRate, String outputPath) throws Exception {
    	Log.i("problem", String.format("MediaCodecSurfaceEncoder width_:%d, height_:%d", width, height));
    ...
    /**
     * Drains all pending output from the decoder_, and adds it to the circular
     * buffer_.
     *
     */
