...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --disable-all --disable-swscale --disable-avfilter --disable-network --disable-postproc --disable-avdevice --target-os=linux --enable-gpl --disable-swscale-alpha --disable-runtime-cpudetect --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-debug --enable-small --enable-pic --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --disable-everything --enable-decoder=mp3 --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-demuxer=mp3 --enable-demuxer=mp4 --enable-demuxer=mov --enable-demuxer=aac --enable-demuxer=h264 --enable-parser=aac --enable-parser=mp3 --enable-parser=h264 --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=mp3_header_compress --enable-bsf=mp3_header_decompress --enable-protocol=file --enable-muxer=mp4 --enable-muxer=mpegts --enable-muxer=aac --prefix=/Users/wlanjie/innotech/android.third.party/build/ffmpeg/armeabi-v7a/ --cross-prefix=arm-linux-androideabi- --target-os=linux --enable-asm --enable-inline-asm --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -mtune=cortex-a9 -mfloat-abi=softfp -mfpu=neon -D__ARM_ARCH_7__ -D__ARM_ARCH_7A__ -Wno-psabi -msoft-float -mthumb -Os -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -DANDROID -Wa,--noexecstack -MMD -MP' --extra-ldflags="
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/wlanjie/innotech/android.third.party/build/ffmpeg/armeabi-v7a//share/ffmpeg"
#define AVCONV_DATADIR "/Users/wlanjie/innotech/android.third.party/build/ffmpeg/armeabi-v7a//share/ffmpeg"
