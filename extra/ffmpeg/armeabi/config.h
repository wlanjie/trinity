...
#define FFMPEG_CONFIGURATION "--arch=arm --enable-nonfree --disable-all --enable-swscale --disable-network --disable-postproc --disable-avdevice --target-os=linux --enable-static --disable-shared --enable-gpl --disable-swscale-alpha --disable-runtime-cpudetect --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-debug --enable-small --enable-pic --enable-avfilter --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --disable-everything --enable-decoder=mp3 --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-demuxer=mp3 --enable-demuxer=mov --enable-demuxer=aac --enable-demuxer=h264 --enable-demuxer=rawvideo --enable-demuxer=flv --enable-demuxer=mpegvideo --enable-muxer=mp4 --enable-parser=aac --enable-parser=mp3 --enable-parser=h264 --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=mp3_header_compress --enable-bsf=mp3_header_decompress --enable-protocol=file --enable-filter=anull --enable-filter=anullsrc --enable-filter=anullsink --enable-filter=aresample --enable-libx264 --enable-encoder=libx264 --enable-libfdk_aac --enable-encoder=libfdk_aac --enable-muxer=adts --prefix=/Users/wlanjie/project/android.third.party/build/ffmpeg/armeabi/ --cross-prefix=arm-linux-androideabi- --target-os=linux --enable-asm --enable-inline-asm --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv5te -mtune=arm9tdmi -msoft-float -I/Users/wlanjie/project/android.third.party/build/x264/armeabi/include -I/Users/wlanjie/project/android.third.party/build/fdk-aac/armeabi/output/include' --extra-ldflags=' -L/Users/wlanjie/project/android.third.party/build/x264/armeabi/lib -lx264 -L/Users/wlanjie/project/android.third.party/build/fdk-aac/armeabi/output/lib -lfdk-aac'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/wlanjie/project/android.third.party/build/ffmpeg/armeabi//share/ffmpeg"
#define AVCONV_DATADIR "/Users/wlanjie/project/android.third.party/build/ffmpeg/armeabi//share/ffmpeg"
